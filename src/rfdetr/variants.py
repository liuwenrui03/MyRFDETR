...
class RFDETRDinoV3ViTSmall(RFDETR):
    """Train an RF-DETR model with DINOv3 ViT Small backbone."""

    size = "rfdetr-dinov3-vit-small"
    _model_config_class = RFDETRDinoV3ViTSmallConfig


class RFDETRDinoV3ConvNextTiny(RFDETR):
    """Train an RF-DETR model with DINOv3 ConvNext Tiny backbone."""

    size = "rfdetr-dinov3-convnext-tiny"
    _model_config_class = RFDETRDinoV3ConvNextTinyConfig


class RFDETRSegDinoV3ConvNextTiny(RFDETRSeg):
    """Train an RF-DETR segmentation model with DINOv3 ConvNext Tiny backbone."""

    size = "rfdetr-seg-dinov3-convnext-tiny"
    _model_config_class = RFDETRSegDinoV3ConvNextTinyConfig
