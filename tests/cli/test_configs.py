...
SEGMENTATION_CONFIGS = [
    ...
    "rfdetr_seg_small",
    "rfdetr_seg_medium",
    "rfdetr_seg_dinov3_convnext_tiny",
]
...
EXPECTED_MODEL_CLASS = {
    ...
    "rfdetr_dinov3_convnext_tiny": "rfdetr.config.RFDETRDinoV3ConvNextTinyConfig",
    ...
    "rfdetr_seg_dinov3_convnext_tiny": "rfdetr.config.RFDETRSegDinoV3ConvNextTinyConfig",
}
